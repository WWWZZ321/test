...
//#define path [NSBundle bundleWithURL:[[NSBundle mainBundle] URLForResource:@"Frameworks/EditorNew" withExtension:@"framework"]]
// 图片路径
#define MLSelectPhotoSrcName(file) [@"Resouce.bundle" stringByAppendingPathComponent:file]
//#define MLSelectPhotoSrcName(file) file
